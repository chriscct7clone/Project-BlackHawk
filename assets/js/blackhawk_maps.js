/* Blackhawk Admin Panel - location finder */
    ...
    blackhawk_maps = {
        init: function() {
            blackhawk_maps.create();
            blackhawk_maps.save_location();
            blackhawk_maps.edit_location();
            blackhawk_maps.show_location();
            ...
            g_Map.gmap3({
                ...
                callback: function(){
                    $('#gmap_search').on('submit', function(){
                       ...
                       blackhawk_maps.drop_marker_search();
                       return false;
                    })
                }
            });
