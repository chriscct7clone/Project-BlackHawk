/* Blackhawk Admin Panel - tables */

	$(document).ready(function() {
		//* datatable must be rendered first
        blackhawk_galery_table.init();
        //* actions for tables, datatables
        blackhawk_select_row.init();
		blackhawk_delete_rows.simple();
		blackhawk_delete_rows.dt();
	});

	//* select all rows
	blackhawk_select_row = {
		init: function() {
