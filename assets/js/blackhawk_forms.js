/* Blackhawk Admin Panel - extended form elements */

	$(document).ready(function() {
		//* masked inputs
		blackhawk_mask_input.init();
		//* datepicker
		blackhawk_datepicker.init();
		//* timepicker
		blackhawk_timepicker.init();
		//* words, characters limit for textarea
		blackhawk_limiter.init();
		//* autosize for textareas
		blackhawk_auto_expand.init();
        //* tag handler for inputs
		blackhawk_tag_handler.init();
        //* input spinners
		blackhawk_spinners.init();
		//* nice form elements
        blackhawk_uniform.init();
		//* jQuery UI sliders
		blackhawk_sliders.init();
		//* animated jQuery UI progressbars
		blackhawk_progressbars.init();
		//* 2col multiselect
		blackhawk_multiselect.init();
		//* enhanced select
		blackhawk_chosen.init();
		//* WYSIWG editor
        blackhawk_wysiwg.init();
        //* multiupload
        blackhawk_multiupload.init();
		//* colorpicker
		blackhawk_colorpicker.init();
