<?php
	...
	$aColumns = array('type','id','percentageofuse','numoftotalspots','numspotsinuse');
	$sIndexColumn = "percentageofuse";
	$sTable = "garage_list";
	/* Database connection information */
	$gaSql['user']       = Config::read('username');
	$gaSql['password']   = Config::read('password');
	$gaSql['db']         = Config::read('database');
	$gaSql['server']     = Config::read('hostname');
	...
	*/
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		$row[] = '<img src="../assets../img/details_open.png">';
