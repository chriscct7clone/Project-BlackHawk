...
if($action == 'secure') {
	...
	$content =  '<meta http-equiv="refresh" content="2;url=roles/student_campus.php" /><p>Redirecting....</p>';
	}
else if($action == 'global') {
	$member->LoggedIn();
	$title   = 'Redirecting';
	$content =  '<meta http-equiv="refresh" content="2;url=statistics/global.php" /><p>Loading Statistics....</p>';
} else{
	$title   = 'Welcome';
